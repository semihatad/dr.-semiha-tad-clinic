            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
              <DialogTrigger asChild>
                ...
                >
                  ...
                  <img
                    src={videoThumbnail}
                    alt="Dt. Semiha Tad Show TV Hayat Güzeldir Programı İmplant Tedavisi"
              ...
              <DialogContent className="max-w-4xl p-0 overflow-hidden border-none bg-black aspect-video sm:rounded-2xl">
                <DialogTitle className="sr-only">
                  Dt. Semiha Tad Show TV Hayat Güzeldir Programı İmplant Tedavisi
                </DialogTitle>
                {isOpen && (
                  <iframe
                    src={embedUrl}
                    title="Dt. Semiha Tad Show TV Hayat Güzeldir"
